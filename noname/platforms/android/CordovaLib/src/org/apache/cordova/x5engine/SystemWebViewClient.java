...
public class SystemWebViewClient extends WebViewClient {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        android.webkit.WebResourceResponse src = this.assetLoader.shouldInterceptRequest(request.getUrl());
        WebResourceResponse response = new WebResourceResponse();

        if (null != src) {
            response.setData(src.getData());
            response.setResponseHeaders(src.getResponseHeaders());
            response.setEncoding(src.getEncoding());
            response.setMimeType(src.getMimeType());
            response.setStatusCodeAndReasonPhrase(src.getStatusCode(), src.getReasonPhrase());
        }
