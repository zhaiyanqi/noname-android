...
import online.nonamekill.android.module.server.R;
import online.nonamekill.android.module.server.server.NonameWebSocketServer;
import online.nonamekill.android.module.server.server.util.NetUtil;
import online.nonamekill.common.module.BaseModule;
import online.nonamekill.common.util.ThreadUtil;

public class ModuleServer extends BaseModule implements View.OnClickListener, MessageAdapterListener {
    ...
    public View getView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.function_server, null);
